...
<body>
	<!--  
		...
		같은 값은 value로 하는 항목이 선택된 상태로 태그가 생성된다.
	 -->
	<h2>test1.jsp입니다.</h2>
	<form:form  modelAttribute= "beanData" action="result">
		...
		<form:checkbox path= "data5" value="JSP과정정"/>JSP과정
		...
		<form:radiobutton path= "data9" value="JSP과정정"/>JSP과정
		...
		<hr>
		<form:radiobuttons path= "data12" items="${requestScope.dataList5 }" itemLabel="key" itemValue="value"/>			
	</form:form>
