...
public class TestController {
	...
	public String result1(Model model) {
		...
		// ByType 방식은 application Scope에 자동으로 저장되지 않아서 model로 request scope에 올려야한다.
	 	model.addAttribute("applicationBean1", applicationBean1);
	 	
	 	// ByName방식은 application Scope에 자동으로 저장해서 model로 request scope에 올리지 않아도 됨
